    ...
    <div class="container-max section-padding">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          ...
          <p class="text-gray-300 mb-6 max-w-md">
            Senior Software Engineer & Technical Partner specializing in Ruby on Rails and React solutions.
            Trusted by industry leaders to deliver scalable, high-performance applications.
          </p>
          <div class="flex space-x-4">
            ...
            <a :href="company.linkedin" class="text-gray-400 hover:text-white transition-colors">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-400 text-sm">
          © 2024 Alex Karpov. All rights reserved.
        </p>
